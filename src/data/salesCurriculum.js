...
export const PILLARS = [
  {
    id: "deballe", icon: "🚪", color: "#FF5C35", soft: "rgba(255,92,53,0.12)",
    title: "Déballe Définitive", subtitle: "Le script PAP validé terrain — les 4 déclencheurs",
    level: 1, priority: "⭐ PRIORITÉ 1 — commence ici", methodRef: "Méthode 01",
    skills: [
      {
        id: "D1", name: "Le Script Exact",
        description: "La phrase d'ouverture validée terrain — à mémoriser mot pour mot",
        importance: 10, timeToMaster: "1-2 séances (mémorisation)",
        ...
        examples: [
          ...
          "Le 'Ça vous va ?' est obligatoire — il dit oui, il est engagé.",
        ...
        tip: "Enregistre-toi sur ton téléphone. Écoute. Recommence jusqu'à ce que ça sonne naturel.",
        quiz: [
          {
            question: "Dans le script, quel est le rôle de 'on a déjà vu plusieurs voisins ce matin' ?",
            options: ["Donner de la crédibilité à Orange", "Activer la preuve sociale — si les voisins ont accepté, c'est normal d'écouter", "Créer une urgence sur le délai", "Obtenir la permission de parler"],
            correct: 1,
            explanation: "Preuve sociale (Cialdini) : les gens font ce que les autres font. 'Vos voisins' dit implicitement 'c'est normal d'ouvrir'.",
          },
          {
            question: "Pourquoi dit-on 'avant qu'on finalise les interventions' ?",
            options: ["Pour être transparent sur le planning", "Pour créer une urgence réelle — la fenêtre se ferme bientôt", "Pour paraître organisé", "C'est une formule de politesse"],
            correct: 1,
            explanation: "Urgence : sans deadline, les gens remettent à plus tard. 'Avant qu'on finalise' = la fenêtre se referme.",
          },
          {
            question: "Tu sonnes. Le prospect ouvre. Il a l'air fermé. Tu fais quoi ?",
            options: ["Tu adaptes le script à son humeur", "Tu dis 'Excusez-moi de vous déranger'", "Tu lances le script exact sans hésitation — ton assuré, sourire dans la voix", "Tu demandes si c'est un bon moment"],
            correct: 2,
            explanation: "L'hésitation se voit et se sent. Un prospect fermé réagit à la certitude.",
          },
        ],
      },
      {
        id: "D2", name: "Les 4 Déclencheurs",
        description: "Les 4 leviers psychologiques dans le script — comprends pourquoi ça marche",
        importance: 9, timeToMaster: "1 séance (comprendre) + terrain (ancrer)",
        ...
        quiz: [
          {
            ...
            options: ["\"Je travaille pour une société partenaire d'Orange\"", "\"Services Orange — on est mandaté sur ce secteur pour les interventions réseau\"", "\"Je suis commercial Orange\"", "\"J'ai mon badge là\""],
            correct: 1,
            explanation: "'Mandaté sur ce secteur pour les interventions réseau' = mission officielle, pas démarche commerciale.",
          },
          {
            question: "Le prospect ne répond pas au 'Ça vous va ?' et te regarde. Tu fais :",
            options: ["Tu répètes la question", "Tu attends 3 secondes en silence — il va répondre", "Tu continues le script sans attendre sa réponse", "Tu demandes s'il a compris"],
            correct: 1,
            explanation: "Silence stratégique. Le premier qui parle perd. Il va répondre.",
          },
        ],
      },
      {
        id: "D3", name: "Transition Entrée Salon",
        description: "Passer du seuil au salon sans demander — la technique des chaussures",
        importance: 8, timeToMaster: "2-3 terrains",
        ...
        quiz: [
          {
            ...
            options: ["\"Super — je peux entrer vérifier votre ligne ?\"", "\"Je vous enlève les chaussures, on vérifie ça ensemble.\" [tu enlèves]", "\"Vous avez 5 minutes pour qu'on regarde ça ?\"", "Tu expliques ce que tu vas faire avant d'entrer"],
            correct: 1,
            explanation: "Pas de question = pas de possibilité de refus. Action immédiate = fait accompli.",
          },
        ],
      },
      {
        id: "D4", name: "Carte de Passage (Absents)",
        description: "La carte qui crée l'obligation de rappeler",
        importance: 7, timeToMaster: "Immédiat",
        ...
        tip: "Le mot 'fermeture du réseau cuivre' crée une urgence réelle — c'est vrai, c'est officiel.",
        examples: [
          "Écris à la main si tu peux — ça paraît plus personnel",
          "Inclure ton prénom (pas nom de famille) — plus humain",
          "Ne mets jamais 'offre commerciale' ou 'tarif' sur la carte",
        ],
        quiz: [
          {
            question: "Pourquoi mentionner 'fermeture du réseau cuivre' sur la carte ?",
            options: ["Pour paraître officiel", "Parce que c'est vrai et que ça crée une urgence réelle — la personne doit agir", "Pour faire plus professionnel", "C'est une formule de politesse"],
            correct: 1,
            explanation: "La fermeture du cuivre est réelle. Mentionner un fait réel et urgent = obligation perçue d'agir.",
          },
        ],
      },
    ],
  ...
  {
    id: "hypnotic", icon: "🧠", color: "#A855F7", soft: "rgba(168,85,247,0.12)",
    title: "Méthode H.Y.P.N.O.T.I.C.", subtitle: "8 étapes — ce n'est plus toi qui vends, c'est lui qui achète",
    level: 2, priority: "⭐⭐ PRIORITÉ 2 — maîtrise après la Déballe", methodRef: "Méthode 02",
    skills: [
      {
        id: "H1", name: "H — Honnîteté (Permission)",
        ...
        quiz: [
          {
            ...
            options: ["Présenter ton offre clairement", "Éteindre le radar anti-vendeur en obtenant une permission", "Créer l'urgence sur ton produit", "Qualifier rapidement s'il peut acheter"],
            correct: 1,
            explanation: "Tant que le radar est activé, rien de ce que tu dis n'entre. La permission = interrupteur.",
          },
        ],
      },
      {
        id: "H2", name: "Y — Y Croire (Posture Médecin)",
        ...
        quiz: [
          {
            ...
            options: ["\"Super — voici notre offre fibre à 32€.\"", "\"Première question : vous êtes sur quel opérateur actuellement ?\"", "\"Je vais vous expliquer ce qu'on propose.\"", "\"Vous connaissez Orange Business ?\""],
            correct: 1,
            explanation: "Diagnostic d'abord. Prescription après.",
          },
        ],
      },
      {
        id: "H3", name: "P — Problème (Creuser la Douleur)",
        ...
        quiz: [
          {
            ...
            options: ["\"Ok, tant mieux pour vous.\" [tu passes au suivant]", "\"Vous regardez jamais Netflix ou YouTube le soir ?\" [trouver l'usage qui révèle le problème]", "\"Ah mais notre offre est quand même très bien.\"", "\"Vous avez jamais eu de coupures ?\""],
            correct: 1,
            explanation: "L'usage spécifique (Netflix, streaming, jeux) révèle le problème que 'ça va bien' cache.",
          },
        ],
      },
      {
        id: "H4", name: "N — Néfaste (Peur de Perdre)",
        ...
        tip: "La peur de perdre est 2x plus puissante que le désir de gagner (Kahneman). N active cette peur.",
        quiz: [
          {
            question: "L'étape N sert à :",
            options: ["Montrer les inconvénients de la concurrence", "Amplifier les conséquences de NE PAS changer — créer l'urgence intérieure", "Présenter les risques de ton offre", "Rappeler que l'offre est limitée dans le temps"],
            correct: 1,
            explanation: "N = Néfaste = ce qu'il perd s'il ne change rien.",
          },
        ],
      },
      {
        id: "H5", name: "O — Objectif (Vision Positive)",
        ...
        tip: "Fais-lui IMAGINER la vie avec le problème résolu. Le cerveau qui imagine valide.",
      },
      {
        id: "H6", name: "T — Traduire (Ses Mots Exacts)",
        ...
        quiz: [
          {
            ...
            options: ["\"Donc votre débit est insuffisant en soirée.\"", "\"Vous avez des problèmes de bande passante.\"", "\"Donc ça rame le soir — c'est bien ça ?\"", "\"Votre connexion n'est pas adaptée à vos besoins.\""],
            correct: 2,
            explanation: "Ses mots exacts ('rame') dans ta reformulation = il se sent parfaitement compris.",
          },
        ],
      },
      {
        id: "H7", name: "I — Imminence (Neutraliser 'Je Réfléchis')",
        ...
        tip: "'Je réfléchis' = signal que tu n'as pas trouvé l'inquiétude réelle. Creuse avec CDD.",
        antiExamples: [
      ...
      {
        id: "H8", name: "C — Clore (Permission Finale)",
        ...
        tip: "La formulation négative ('contre l'idée') est clé. Dire non à une formulation négative = dire oui.",
        examples: [
        ...
        quiz: [
          {
            ...
            options: ["C'est plus poli", "La formulation négative rend le refus psychologiquement difficile — dire non = prendre une position active contre quelque chose", "C'est plus professionnel", "Ça fait moins vendeur"],
            correct: 1,
            explanation: "'voulez-vous' = il faut activer l'envie pour dire oui. 'Contre l'idée' = il faut s'opposer activement pour dire non.",
          },
        ],
      },
    ],
  ...
  {
    id: "cdd", icon: "🛡️", color: "#FFB800", soft: "rgba(255,184,0,0.12)",
    title: "Méthode C.D.D.", subtitle: "Clarifier · Discuter · Dissiper — l'art de gérer les objections",
    level: 2, priority: "⭐⭐ PRIORITÉ 2 — indispensable dès ton 1er contrat", methodRef: "Méthode 03",
    skills: [
      {
        id: "C1", name: "Principe Fondamental",
        ...
        quiz: [
          {
            ...
            options: ["\"Ça prend que 2 minutes, je vous promets.\"", "\"Je comprends — mais si vous aviez 2 minutes, y a-t-il une information que vous auriez aimé avoir sur votre ligne ?\"", "\"Ok, quand est-ce que je peux repasser ?\"", "\"Nos clients disent tous ça au début.\""],
            correct: 1,
            explanation: "Tu ne combats pas 'pas le temps'. Tu crées une ouverture hypothétique ('si vous aviez') et tu plantes une curiosité.",
          },
        ],
      },
      {
        id: "C2", name: "C — Clarifier (Enlever l'Écran de Fumée)",
        ...
        quiz: [
          {
            ...
            options: ["\"Vous pouvez y réfléchir et je repasserai.\"", "\"Pas intéressé par quoi exactement — vous avez un souci avec Orange ?\"", "\"Écoutez, notre offre est vraiment très bien.\"", "\"Tout le monde dit ça au début.\""],
            correct: 1,
            explanation: "C = creuser. 'Pas intéressé par quoi ?' force une réponse précise et révèle la vraie objection.",
          },
        ],
      },
      {
        id: "C3", name: "D — Discuter (Technique Tea Time)",
        ...
        tip: "Tea Time = tu prends un thé avec lui, tu écoutes sa mauvaise expérience passée avec curiosité SINCÈRE.",
        examples: [
          "Il dit qu'un commercial l'a arnaqé → 'Ah ? Qu'est-ce qui s'était passé ?' [laisse parler 2 minutes]",
        ...
        quiz: [
          {
            ...
            options: ["Tu l'interromps : \"Oui mais nous on est différents parce que...\"", "Tu laisses parler jusqu'au bout. Puis : \"Je comprends. Et c'est pour ça que je fonctionne différemment...\"", "Tu demandes s'il a un contrat en cours", "Tu prends note pour répondre point par point"],
            correct: 1,
            explanation: "Laisser parler jusqu'au bout = il se sent entendu = il baisse sa garde.",
          },
        ],
      },
      {
        id: "C4", name: "D — Dissiper (L'Aider à Se Rassurer)",
        ...
        quiz: [
          {
            ...
            options: ["\"Ça se passera très bien, je vous l'assure.\"", "\"Je comprends. Et si on regardait ensemble ce que ça change concrètement — si vous trouvez que c'est pas dans votre intérêt, je repars sans insister.\"", "\"Nos clients sont tous satisfaits, statistiquement.\"", "\"Faites-moi confiance, j'ai de l'expérience.\""],
            correct: 1,
            explanation: "Tu lui donnes le contrôle ('si vous trouvez que c'est pas dans votre intérêt'). Il se rassure lui-même.",
          },
        ],
      },
      {
        id: "C5", name: "Les 3 Objections Terrain",
        description: "Tes 3 objections les plus fréquentes — réponses exactes CDD",
        importance: 10, timeToMaster: "Mémoriser les réponses + les tester 10x terrain",
        ...
        quiz: [
          {
            ...
            options: ["C: 'Notre offre est moins chère' D: 'On est les meilleurs' D: 'Vous seriez surpris'", "C: 'Satisfait sur tout — débit, prix, service client ?' D: 'Qu'est-ce qui vous plaît le plus ?' D: 'Si je pouvais vous montrer ce qui change avec la fibre — ça vous intéresserait ?'", "C: 'OK' D: [rien] D: 'Quand même lisez notre brochure'", "C: 'Quel opérateur ?' D: 'Combien vous payez ?' D: 'Nous c'est moins cher'"],
            correct: 1,
            explanation: "C = creuser le 'satisfait'. D = comprendre ce qu'il valorise. D = proposition conditionnelle.",
          },
        ],
      },
    ],
  ...
  {
    id: "intonations", icon: "🎙️", color: "#EC4899", soft: "rgba(236,72,153,0.12)",
    title: "Les 4 Intonations Magiques", subtitle: "Comment tu parles > ce que tu dis",
    level: 1, priority: "⭐ PRIORITÉ 1 — travaille ça en parallèle du script", methodRef: "Méthode 04",
    skills: [
      {
        id: "V1", name: "Intonation Secrète",
        ...
        quiz: [
          {
            ...
            options: ["Quand il est agressif", "Quand tu présentes un avantage ou information exclusive — pour créer de la valeur perçue", "Quand tu ne sais pas quoi dire", "Au moment de la signature"],
            correct: 1,
            explanation: "Secret = valeur perçue + complicité. Si c'est 'secret', c'est précieux.",
          },
        ],
      },
      {
        id: "V2", name: "Intonation Taquine",
        ...
        quiz: [
          {
            ...
            options: ["\"Je comprends, mais je vous assure que je suis différent.\"", "[sourire dans la voix] 'Haha — vous êtes populaire dans le quartier alors ! Dites, la dernière fois ils vous ont demandé quoi ?' [curiosité amusée]", "\"Je suis pas un commercial, je suis technicien.\"", "\"Je suis désolé si vous avez été beaucoup sollicité.\""],
            correct: 1,
            explanation: "La taquine désarme avec l'humour. Elle montre que tu n'es pas affecté, que tu es à l'aise.",
          },
        ],
      },
      {
        id: "V3", name: "Intonation Compassion",
        ...
        tip: "La compassion réelle (pas simulée) se sent. Ralentis vraiment. Pense sincèrement à une frustration que toi tu as vécue.",
        examples: [
      ...
      {
        id: "V5", name: "Règles des Silences",
        ...
        tip: "Un silence de 3 secondes semble interminable pour toi. Pour lui, c'est normal. Compte dans ta tête : 1001, 1002, 1003.",
        quiz: [
          {
            question: "Tu poses une question de closing. Il hésite. 5 secondes de silence. Tu :",
            options: ["Ajoutes un argument supplémentaire pour l'aider à décider", "Demandes si tout va bien", "Continues à te taire jusqu'à 10 secondes minimum", "Proposes un délai de réflexion"],
            correct: 2,
            explanation: "Le premier qui parle après une question de closing PERD. 5 secondes = normal. 10 secondes = il va parler.",
          },
        ],
      },
    ],
  ...
  {
    id: "mots", icon: "🚫", color: "#EF4444", soft: "rgba(239,68,68,0.12)",
    title: "Mots Interdits", subtitle: "7 expressions qui sabotent tes ventes — et leurs remplaçants",
    level: 1, priority: "⭐ PRIORITÉ 1 — à mémoriser cette semaine", methodRef: "Méthode 05",
    skills: [
      {
        id: "M1", name: "Les 7 Mots Interdits",
        description: "Chaque mot a un effet psychologique négatif précis",
        importance: 10, timeToMaster: "Mémorisation : 1 semaine. Désancrage : 3-4 semaines terrain.",
        ...
        examples: [
          "\"Faites-moi confiance\" → INTERDIT — demander la confiance = admettre qu'on ne l'a pas méritée → REMPLACEMENT : montre-la par tes actes",
          "\"Honnêtement\" → INTERDIT — suggestion négative inversée (tu viens d'être malhonnnête ?) → REMPLACEMENT : dire la vérité simplement",
          ...
          "\"Conforme\" → INTERDIT — mot administratif anxi ogène → REMPLACEMENT : 'capacité réelle' ou 'ce que vous avez vraiment'",
        ],
        quiz: [
          {
            question: "Tu veux dire que tu es sûr que le client sera satisfait. Comment ?",
            options: ["\"Je suis sûr que vous allez adorer.\"", "\"Faites-moi confiance, vous serez satisfait.\"", "\"La grande majorité de nos clients dans votre profil remarquent la différence dès le premier mois.\"", "\"Honnêtement, vous ne le regretterez pas.\""],
            correct: 2,
            explanation: "Preuve sociale (majorité de clients) + profil spécifique (dans votre cas) + temporalité précise (premier mois). Aucun mot interdit.",
          },
          {
            question: "Il dit quelque chose d'étrange sur les opérateurs. Tu veux comprendre. Tu demandes :",
            options: ["\"Pourquoi vous dites ça ?\"", "\"Qu'est-ce qui vous fait penser ça ?\"", "\"Comment ça se fait ?\"", "\"C'est une idée reçue.\""],
            correct: 1,
            explanation: "'Pourquoi' = accusateur, met l'autre sur la défensive. 'Qu'est-ce qui vous fait penser' = curiosité, invitation à s'expliquer.",
          },
          {
            question: "Tu arrives à la porte. Le bon premier mot :",
            options: ["\"Excusez-moi de vous déranger...\"", "\"Bonsoir, désolé de vous interrompre...\"", "\"Bonsoir !\" [sourire, posture droite, main tendue]", "\"Bonjour, je m'excuse mais...\""],
            correct: 2,
            explanation: "Bonjour ferme + posture assurée = tu es là avec une mission légitime.",
          },
        ],
      },
    ],
  ...
  {
    id: "mental", icon: "🧘", color: "#22C55E", soft: "rgba(34,197,94,0.12)",
    title: "État Mental — Protocole T.R.U.S.T.", subtitle: "La performance mentale qui précède la performance terrain",
    level: 1, priority: "⭐ PRIORITÉ 1 — activer avant chaque session terrain", methodRef: "Méthode 06",
    skills: [
      {
        id: "T1", name: "Protocole T.R.U.S.T.",
        ...
        examples: [
          ...
          "U — UVISUALIZE : Rappelle-toi ton meilleur contrat. La tête du client qui a dit oui. Reproduis cet état corporel.",
          "S — SEAL BREATHING : 4s inspire / 4s retenir / 4s expire / 4s vide. Répète 4 fois.",
          "T — TERRAIN ACE : Attendre 2-3s avant de sonner / Calmer le corps / Écouter pour comprendre (pas pour répondre).",
        ],
        tip: "L'état mental se voit sur le visage et s'entend dans la voix. Un commercial qui doute = prospect qui doute.",
        quiz: [
          {
            question: "Tu viens de prendre 5 refus consécutifs. Tu es découragé. Première étape T.R.U.S.T. :",
            options: ["Tu appelles un collègue pour te remotiver", "Tu fais une pause café", "T — Tu tues le doute : 'Ces 5 non me rapprochent mathématiquement du prochain oui. C'est la loi des nombres.'", "Tu te dis que ça va aller"],
            correct: 2,
            explanation: "Le doute est une pensée, pas une réalité. La remplacer par un FAIT (loi des nombres) coupe l'émotion.",
          },
        ],
      },
      {
        id: "T2", name: "Mantra Terrain",
        ...
        tip: "Dis-le à voix basse avant de sonner. Ça reprogramme ta posture de 'vendeur qui dérange' à 'expert qui aide'.",
        examples: [
        ...
        quiz: [
          {
            ...
            options: ["9h-12h — les retraités sont là", "14h-17h — les gens sont disponibles", "17h-20h — retours du travail, décisions à deux", "20h-22h — ils sont détendus"],
            correct: 2,
            explanation: "17h-20h = retours du travail + les deux membres du couple présents = décision possible immédiatement.",
          },
        ],
      },
    ],
...
export const RP_SCENARIOS = [
  {
    id: "deballe_premiere", icon: "🚪", emoji: "👩",
    title: "Déballe Définitive", subtitle: "Madame Moreau — Porte froide",
    tag: "Script", tagColor: "#FF5C35", tagSoft: "rgba(255,92,53,0.12)",
    difficulty: 1, xpMax: 40,
    voiceId: "XB0fDUnXU5powFXDhCwa", voiceName: "Charlotte", voiceGender: "Femme",
    voiceSettings: { stability: 0.55, similarity_boost: 0.80, style: 0.20, use_speaker_boost: true },
    targetSkills: ["D1", "D2", "D3"], primarySkill: "D1",
...
- Si le vendeur te propose d'entrer : tu hésites légèrement mais tu peux accepter si sa posture est assurée
...
Retourne UNIQUEMENT ce JSON :
{
  ...
  "tip_specifique": "<conseil précis sur un des 4 déclencheurs>"
    ...
    color: "#FF5C35", soft: "rgba(255,92,53,0.12)",
  },
  {
    id: "hypnotic_complet", icon: "🧠", emoji: "👨",
    title: "HYPNOTIC Complet", subtitle: "M. Leclerc — Du diagnostic à la permission finale",
    tag: "Intermédiaire", tagColor: "#A855F7", tagSoft: "rgba(168,85,247,0.12)",
    difficulty: 2, xpMax: 70,
    voiceId: "TX3LPaxmHKxFdv7VOQHJ", voiceName: "Liam", voiceGender: "Homme",
    voiceSettings: { stability: 0.50, similarity_boost: 0.75, style: 0.25, use_speaker_boost: true },
    targetSkills: ["H2", "H3", "H4", "H6", "H8"], primarySkill: "H3",
    skillFocus: "H.Y.P.N.O.T.I.C. — Diagnostic → Problème → Néfaste → Clore",
    context: "Homme 45 ans, cadre, a accepté de t'écouter 2 minutes.",
    objective: "Progresser H→Y→P→N→O→T→I→C dans l'ordre. Ne jamais pitcher avant d'avoir diagnostiqué.",
    tip: "Posture médecin : commence par 'Première question — vous avez quel opérateur actuellement ?'",
...
- H : Si le vendeur dit "je suis pas là pour vendre / deux questions" → tu dis "OK, qu'est-ce que c'est ?"
- Y : Si le vendeur te pose des questions sur ton opérateur/usage → tu réponds (tu as Bouygues, box classique)
- P : Si le vendeur creuse sur les lenteurs → tu avoues "bah le soir quand ma fille regarde ses séries c'est un peu galère"
- N : Si le vendeur te demande ce que ça change → "bah elle m'engueule et j'ai du mal à télétravailler le soir"
- O : Si le vendeur te fait imaginer la solution → tu montres un intérêt réel
- T : Tu remarques si le vendeur reprend TES mots (galère, engueule)
- I : Si tu dis "j'ai besoin de réfléchir" → tu as une vraie question sur le délai d'installation
- C : Si le vendeur dit "seriez-vous contre l'idée que..." → tu hésites puis acceptes
...
3. A-t-il creusé le problème (P) ?
4. A-t-il activé la peur de perdre (N) ?
...
Retourne UNIQUEMENT ce JSON :
{
  ...
  "etape_actuelle": "<H/Y/P/N/O/T/I/C>",
  "point_fort": "<max 12 mots>",
  "point_faible": "<max 12 mots>",
    ...
    exercises: [
      {
        ...
        correct: 1,
        explanation: "Étape Y = Diagnostic. On commence par une question, pas par une présentation.",
      },
    ],
    color: "#A855F7", soft: "rgba(168,85,247,0.12)",
  },
  {
    id: "cdd_objections", icon: "🛡️", emoji: "👨‍💼",
    title: "Méthode C.D.D.", subtitle: "Bernard — Objections en rafale",
    tag: "Objections", tagColor: "#FFB800", tagSoft: "rgba(255,184,0,0.12)",
    difficulty: 2, xpMax: 60,
    voiceId: "JBFqnCBsd6RMkjVDRZzb", voiceName: "George", voiceGender: "Homme",
    voiceSettings: { stability: 0.40, similarity_boost: 0.75, style: 0.40, use_speaker_boost: true },
    targetSkills: ["C1", "C2", "C3", "C4"], primarySkill: "C2",
    skillFocus: "C.D.D. — Ne jamais répondre directement à une objection",
    context: "Homme 58 ans, qui a déjà été démarché. Il sort les objections classiques une par une.",
    objective: "Appliquer C → D → D sur chaque objection. Ne jamais défendre ton offre avant d'avoir compris la vraie inquiétude.",
    tip: "Face à 'pas intéressé' : 'Pas intéressé par quoi exactement ?' — puis silence.",
    prospectSystem: `Tu joues Bernard, 58 ans, retraité de la fonction publique. Tu as été démarché plusieurs fois.

Comportement :
- Première objection : "Je suis pas intéressé"
- Si le vendeur clarifie : tu dis "Bah j'ai pas besoin de changer"
- Si le vendeur discute avec curiosité : tu parles d'une mauvaise expérience avec un opérateur il y a 2 ans
- Si le vendeur écoute sans interrompre (Tea Time) : tu te détends
...
Analyse :
1. C — CLARIFIER : Le vendeur a-t-il creusé l'objection AVANT d'argumenter ?
2. D — DISCUTER : A-t-il posé une question empathique et écouté sans interrompre (Tea Time) ?
3. D — DISSIPER : A-t-il aidé le prospect à se rassurer lui-même ?

Retourne UNIQUEMENT ce JSON :
{
  "score": <1-10>,
  "skill_evalued": "Méthode CDD",
  "etape_cdd": "<C ou D(discuter) ou D(dissiper)>",
  "point_fort": "<max 12 mots>",
  "point_faible": "<max 12 mots>",
    ...
    exercises: [
      {
        ...
        correct: 1,
        explanation: "C = creuser l'objection. 'Par quoi exactement' force une réponse précise.",
      },
    ],
    color: "#FFB800", soft: "rgba(255,184,0,0.12)",
  },
  {
    id: "intonations_live", icon: "🎙️", emoji: "👩‍💼",
    title: "Les 4 Intonations", subtitle: "Sandra — Adapter son ton en temps réel",
    tag: "Vocal", tagColor: "#EC4899", tagSoft: "rgba(236,72,153,0.12)",
    difficulty: 2, xpMax: 55,
    voiceId: "EXAVITQu4vr4xnSDxMaL", voiceName: "Sarah", voiceGender: "Femme",
    voiceSettings: { stability: 0.60, similarity_boost: 0.75, style: 0.20, use_speaker_boost: true },
    targetSkills: ["V1", "V2", "V3", "V5"], primarySkill: "V5",
    skillFocus: "Intonations : Secrète · Taquine · Compassion + Silences stratégiques",
    context: "Femme 40 ans, sympa mais occupée. Elle passe par des états différents : blasée → curieuse → qui se confie.",
    objective: "Détecter l'état émotionnel du prospect et utiliser la bonne intonation.",
    tip: "Taquine sur sa première résistance → Secrète quand tu partages une info → Compassion quand elle se confie.",
    prospectSystem: `Tu joues Sandra, 40 ans, responsable RH. Tu es sympa mais tu as vu beaucoup de commerciaux.

ÉTAT 1 — BLASÉE : Tu réponds poliment avec un léger ton d'impatience. Si le vendeur utilise l'intonation TAQUINE : tu souris légèrement.
ÉTAT 2 — CURIEUSE : Si le vendeur utilise l'intonation SECRÈTE : tu te penches en avant.
ÉTAT 3 — QUI SE CONFIE : Tu mentionnes que tu travailles de chez toi 3 jours par semaine et que les coupures posent problème. Si le vendeur réagit avec COMPASSION et garde le SILENCE : tu continues à te confier.
...
Analyse :
1. TAQUINE : Réaction avec légèreté/humour à la résistance initiale ?
2. SECRÈTE : Information partagée avec voix confidentielle ?
3. COMPASSION : Face à la confidence, a-t-il ralenti, adouci son ton ?
4. SILENCE : A-t-il laissé des silences de 3s+ après ses questions importantes ?
    ...
    exercises: [
      {
        ...
        correct: 2,
        explanation: "Taquine = désarme avec l'humour. Elle montre que tu n'es pas affecté.",
      },
    ],
    color: "#EC4899", soft: "rgba(236,72,153,0.12)",
  },
  {
    id: "mots_interdits_live", icon: "🚫", emoji: "👴",
    title: "Mots Interdits", subtitle: "Raymond — Le détecteur de mots saboteurs",
    tag: "Langage", tagColor: "#EF4444", tagSoft: "rgba(239,68,68,0.12)",
    difficulty: 1, xpMax: 45,
    voiceId: "JBFqnCBsd6RMkjVDRZzb", voiceName: "George", voiceGender: "Homme",
    voiceSettings: { stability: 0.45, similarity_boost: 0.70, style: 0.35, use_speaker_boost: true },
    targetSkills: ["M1"], primarySkill: "M1",
    skillFocus: "Éliminer les 7 mots interdits — chaque mot compte",
    context: "Homme 65 ans, ancien cadre. Il est perspicace et remarque TOUT dans ton vocabulaire.",
    objective: "Avoir une conversation entière sans utiliser un seul mot interdit.",
    tip: "Les 7 mots : 'faites-moi confiance', 'honnêtement', 'en toute transparence', 'je suis sûr que', 'pourquoi ?', 'excusez-moi de vous déranger', 'conforme'.",
    prospectSystem: `Tu joues Raymond, 65 ans, ancien directeur commercial. Tu es très perceptif aux expressions manipulatoires.
...
- "Honnêtement" → "Vous étiez malhonête jusqu'à maintenant ?"
...
Si le vendeur évite tous ces mots → tu t'intéresses vraiment.

1-2 phrases. Ton direct, testeur mais respectueux.`,
    coachSystem: `Tu es coach expert vente PAP. Tu évalues UNIQUEMENT l'absence de mots interdits.

Les 7 mots interdits : "faites-moi confiance", "honnêtement", "en toute transparence", "je suis sûr que", "pourquoi ?", "excusez-moi de vous déranger", "conforme"

Retourne UNIQUEMENT ce JSON :
{
  "score": <1-10>,
  "skill_evalued": "Vocabulaire & Mots Interdits",
  "mots_interdits_detectes": ["<mot1>"] ou [],
  "point_fort": "<max 12 mots>",
  "point_faible": "<max 12 mots>",
  ...
  "tip_specifique": "<conseil sur le remplacement du mot le plus problématique>"
    ...
    color: "#EF4444", soft: "rgba(239,68,68,0.12)",
  },
  {
    id: "champion_complet", icon: "⚔️", emoji: "🏆",
    title: "Mode Champion", subtitle: "Prospect Mystère — Toutes méthodes",
    tag: "Expert", tagColor: "#22C55E", tagSoft: "rgba(34,197,94,0.12)",
    difficulty: 3, xpMax: 100,
    voiceId: "Xb7hH8MSUJpSbSDYk0k2", voiceName: "Alice", voiceGender: "Surprise",
    voiceSettings: { stability: 0.50, similarity_boost: 0.75, style: 0.30, use_speaker_boost: true },
    targetSkills: ["D1", "H3", "C2", "V2", "M1"], primarySkill: "D1",
    skillFocus: "Toutes les méthodes — Déballe → HYPNOTIC → CDD → Intonations",
    context: "Prospect mystère. Type aléatoire. Tu dois identifier rapidement le profil et chaîner les bonnes méthodes.",
    objective: "Déballe → diagnostiquer le profil en 2 échanges → sélectionner la bonne méthode → l'appliquer sans mots interdits.",
    tip: "Écoute les 2 premières phrases. Elles te disent tout : agressif=CDD, ouvert=HYPNOTIC, blasé=Taquine, méfiant=CDD clarifier.",
    prospectSystem: `Tu joues un prospect aléatoire Orange PAP. Choisis exactement UN profil parmi ces 5 et reste COHÉRENT :
...
2. MÉTHODE ADAPTÉE : A-t-il choisi la bonne méthode ?
3. MOTS INTERDITS : A-t-il évité tous les mots saboteurs ?
4. PROGRESSION : A-t-il progressé dans la méthode choisie ?
...
export const PROGRESSION = {
  ...
  recommendations: {
    ...
    5: ["HYPNOTIC complet H → C", "Mode Champion — toutes méthodes enchâînées"],
